	  ...
	  <div class="container-fluid">
	    <div class="quick-actions_homepage">
	        <ul class="quick-actions">
		        <li class="bg_lr"> <a href="{{route('admin.train.index')}}"> <i class="icon-dashboard"></i>Vé tàu</a> </li>
		        <li class="bg_ly"> <a href="{{route('admin.post.index')}}"> <i class="icon-inbox"></i>Tin tức</a> </li>
		        <li class="bg_lv"> <a href="{{route('admin.email.index')}}"> <i class="icon-inbox"></i>Email</a> </li>
		        <li class="bg_ls"> <a href="{{route('admin.cart.index')}}"> <i class="icon-fullscreen"></i>Giỏ hàng</a> </li>
