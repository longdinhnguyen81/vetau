...
@endif
      <div class="span12">
        	<a href="{{route('admin.post.add')}}" class="btn btn-success">Thêm</a>
            ...
            <table class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr class="even gradeA">
                  ...
                  <td><img style="width:300px" src="/upload/{{$new->picture}}" /></td>
                  ...
                  <td class="text-center">
                  	<a href="{{route('admin.post.edit', $new->id)}}" class="btn btn-primary">Sửa</a>
                  	<a onclick="return confirm('Do you want to delete this news?')" href="{{route('admin.post.delete', $new->id)}}" class="btn btn-danger">Xóa</a>
                  </td>
                </tr>
                @endforeach
              </tbody>
