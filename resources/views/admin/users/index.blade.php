...
@endif
      <div class="span12">
        	<a href="{{route('admin.users.add')}}" class="btn btn-success">Thêm</a>
              ...
              <tbody>
                ...
                <tr class="even gradeA">
                  ...
                  <td class="text-center">
                  	...
                  	<a onclick="return confirm('Do you want to delete this user?')" href="{{route('admin.users.delete', $user->id)}}" class="btn btn-danger">Xóa</a>
                  </td>
                </tr>
                @endforeach
              </tbody>
